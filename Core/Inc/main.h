...
#define PIN_PWM_UH_Pin GPIO_PIN_8
#define PIN_PWM_UH_GPIO_Port GPIOA
#define PIN_PWM_VH_Pin GPIO_PIN_9
#define PIN_PWM_VH_GPIO_Port GPIOA
#define PIN_PWM_WH_Pin GPIO_PIN_10
#define PIN_PWM_WH_GPIO_Port GPIOA
